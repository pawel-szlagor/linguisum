...
public class IntegratorReader implements ItemReader<SnapshotSourceDto>, InitializingBean {
    ...
    public synchronized SnapshotSourceDto read() {
        if (counter < 86400) {
            SnapshotSourceDto snapshotSourceDto = snapshotSourceService.findByDateTime(currentDateTime.plusSeconds(counter), day);
    ...
    public void afterPropertiesSet() {
        ...
        day = daySourceService.findDaySourceByDateOrderedByTime(dayToRead);
    }
}
